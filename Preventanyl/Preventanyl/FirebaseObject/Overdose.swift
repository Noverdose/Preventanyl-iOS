...
//        }
        ...
        self.id = dict["id"] as? String ?? Overdose.getId(timestamp: timestamp, latitude: latitude, longitude: longitude)
...
//        self.coordinates.longitude = longitude
    ...
    init(region: String?, reportedTime: Date, coordinates: CLLocationCoordinate2D) {
        ...
        self.id = Overdose.getId(timestamp: reportedTime.timeIntervalSince1970, latitude: coordinates.latitude, longitude: coordinates.longitude)
